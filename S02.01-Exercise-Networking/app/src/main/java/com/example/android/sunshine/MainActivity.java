...
public class MainActivity extends AppCompatActivity {
    ...
    private class FetchWeatherDataTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... strings) {
            ...
            URL reqUrl = NetworkUtils.buildUrl(loc);
            try {
                String rawJson = NetworkUtils.getResponseFromHttpUrl(reqUrl);
                String[] parsedJson = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, rawJson);
        ...
        protected void onPostExecute(String[] strings) {
            if (strings != null)
                Arrays.stream(strings).forEach(v -> mWeatherTextView.append(v + "\n\n"));
        }
    }
